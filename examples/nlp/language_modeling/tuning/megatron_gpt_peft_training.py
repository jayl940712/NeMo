...
from nemo.collections.nlp.models.language_modeling.megatron_gpt_model import MegatronGPTPEFTModel
...
@hydra_runner(config_path="conf", config_name="megatron_gpt_peft_training_config")
def main(cfg) -> None:
    ...
    model_cfg = MegatronGPTPEFTModel.merge_cfg_with(cfg.model.restore_from_path, cfg)
    model = MegatronGPTPEFTModel.restore_from(cfg.model.restore_from_path, model_cfg, trainer=trainer)
